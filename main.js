...
global.owner = ['919048410619','919048410619','919048410619'] // Put your number here
global.mods = ['919048410619','919048410619'] // Want some help?
global.prems = ['919048410619','919048410619'] // Premium user has unlimited limit
...
setInterval(async () => {
  ...
  if (JSON.stringify(global.DATABASE.data) == lastJSON) conn.logger.info('Database is up to date')
    ...
    conn.logger.info('Done saving database, YouTube: mr.ravanan!')
...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'This command can only be used by _*OWNER Bot 1*_ _*make your own bot : https://youtube.com/c/MrRavanan*_',
    owner: 'This command can only be used by _*Owner Bot*_ _*make your own bot : https://youtube.com/c/MrRavanan*_!',
    mods: 'This command can only be used by _*Moderator BOT*_ !',
    premium: 'This command is for members only _*Premium*_ _*make your own bot : https://youtube.com/c/MrRavanan*_ !',
    group: 'This command can only be used in groups!',
    private: 'This command can only be used in Private Chats _*make your own bot : https://youtube.com/c/MrRavanan*_!',
    admin: 'This command is for *Admin* grup _*make your own bot : https://youtube.com/c/MrRavanan*_!',
    botAdmin: 'Make bots as *Admin* to use this command _*make your own bot : https://youtube.com/c/MrRavanan*_!',
  }[type]
